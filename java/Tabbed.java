    ...
    JPanel   jpanel    = new JPanel();
      ...
      case 0:
        ...
        /*If Widget Type ix ComboBox then this is the list*/
		    ...
		    Widget tw = new Widget(labelName);
				component[idx] = tw.buildTestCommandUI(labelName, 
												widgetType, 
												optionList);
			}
       	break;
			case 2:
			{
		    String[] labelName = {"AT Read Command", 
        ...
        /*If Widget Type ix ComboBox then this is the list*/
		    ...
		    Widget tw = new Widget(labelName);
				component[idx] = tw.buildReadCommandUI(labelName,
			...
			case 4:
			{
		    String[] labelName = {"AT Execution Command", 
        ...
        /*If Widget Type ix ComboBox then this is the list*/
		    ...
		    Widget tw = new Widget(labelName);
			  component[idx] = tw.buildExecutionCommandUI(labelName, widgetType,
												optionList);
			}
				break;
			...
			case 5:
      {
        ...
        /*If Widget Type ix ComboBox then this is the list*/
		    ...
		    Widget SMS_w = new Widget(SMS_label);
			  component[idx] = SMS_w.buildSMSUI(SMS_label, widgetType,
												                  optionList);
			}
				break;
			...
			case 6:
      {
        ...
        /*If Widget Type ix ComboBox then this is the list*/
		    ...
		    Widget CSIM_w = new Widget(CSIM_label);
			  component[idx] = CSIM_w.buildCSIMUI(CSIM_label, 
												widgetType, 
												optionList);
			}
				break;
			...
			case 7:
      {
		    ...
		    Widget CRSM_w = new Widget(CRSM_label);
			  component[idx] = CRSM_w.buildCRSMUI(CRSM_label, 
												widgetType, 
												optionList);
			}
				break;
