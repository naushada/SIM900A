...
public Component buildCSIMUI(String[] labelName, String[] widgetType, String[][] optionList) {
	Component c1 = buildLabelWidget(labelName.length, labelName);
...
public Component buildCRSMUI(String[] labelName, String[] widgetType, String[][] optionList) {
	Component c1 = buildLabelWidget(labelName.length, labelName);
	Component c2 = buildWidget(labelName.length, labelName, widgetType, optionList);
	Component c3 = buildButtonWidget("SEND", "CLEAR");
	Component c  = glueComponent(c1, c2);
...
public Component buildSMSUI(String[] labelName, String[] widgetType, String[][] optionList) {
	Component c1 = buildLabelWidget(labelName.length, labelName);
	Component c2 = buildWidget(labelName.length, labelName, widgetType, optionList);
	Component c3 = buildButtonWidget("SEND", "CLEAR");
	Component c  = glueComponent(c1, c2);
...
public Component buildTestCommandUI(String[] labelName, String[] widgetType, String[][] optionList) {
	Component c1 = buildLabelWidget(labelName.length, labelName);
	Component c2 = buildWidget(labelName.length, labelName, widgetType, optionList);
	Component c3 = buildButtonWidget("OK", "CANCEL");
	Component c  = glueComponent(c1, c2);
...
public Component buildExecutionCommandUI(String[] labelName, String[] widgetType, String[][] optionList) {
	Component c1 = buildLabelWidget(labelName.length, labelName);
	Component c2 = buildWidget(labelName.length, labelName, widgetType, optionList);
	Component c3 = buildButtonWidget("OK", "CANCEL");
	Component c  = glueComponent(c1, c2);
